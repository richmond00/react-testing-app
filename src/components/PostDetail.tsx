...
export function PostDetail({ post, deleteMutation, updateMutation }: {post: any, deleteMutation: UseMutationResult<any, Error, void, unknown>, updateMutation: UseMutationResult<any, Error, void, unknown> }) {
